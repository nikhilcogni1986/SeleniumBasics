...
public class RadioButton {
    ...
    public void radioButtonTest() {
        ...
        boolean isMaleRadioButtonEnabled = driver.findElement(By.xpath("(//input[@value='Male'])[1]")).isEnabled();
        System.out.println("Radio button for Male enabled is " + isMaleRadioButtonEnabled);

        boolean isFemaleRadioButtonEnabled = driver.findElement(By.xpath("(//input[@value='Female'])[1]")).isEnabled();
        ...
        WebElement expected_message_male = driver.findElement(By.xpath("//p[contains(text(),\"Radio button 'Male' is checked\")]"));
        Assert.assertTrue(expected_message_male.isDisplayed());

        driver.findElement(By.xpath("(//input[@value='Female'])[1]")).click();
        driver.findElement(By.id("buttoncheck")).click();
        WebElement expected_message_female = driver.findElement(By.xpath("//p[contains(text(),\"Radio button 'Female' is checked\")]"));
